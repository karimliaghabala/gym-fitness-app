    ...
    <>
      <div className='header'>  
        ...
        <ul className='header-menu'>
          <li><Link onClick={()=> setMenuOpened(false)} to='header'  smooth={true}>Home</Link></li>
          ...
          <li><Link onClick={()=> setMenuOpened(false)} to='testimonials'  smooth={true}>Testimonials</Link></li>
        </ul>)}
      </div>
    </>
  )
